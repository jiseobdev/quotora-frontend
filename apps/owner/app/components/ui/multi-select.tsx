...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-wrap gap-1 p-1 py-2 rounded-lg bg-background border border-gray-300",
        {
          "focus-within:ring-indigo-500 focus-within:border-indigo-500": activeIndex === -1,
        },
        className,
      )}
      {...props}
