      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <Form className="space-y-6" method="POST">
          ...
          <div>
            ...
            <textarea id="rawfirms" name="rawfirms" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#4F46E5] h-32" placeholder="제안서를 받을 자문사의 이름이나 조건을 기재해주세요 (쉼표로 구분)" defaultValue={rfp?.rawfirms.join(', ')}></textarea>
          </div>
